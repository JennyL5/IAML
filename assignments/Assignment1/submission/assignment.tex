...
\newcommand{\assignmentAuthorName}{s1705544}
%--------------------------------------------------------
...
\answer[15em]{\textbf{Answer Box (3.)}:\\%
    ...
    This increase in performance is because linear regression is sensitive to outliers and outliers exist in engine-size. 
    The outliers have a relatively large value, the logarithm minimises the value, and the influence of the outliers would minimise with it. 
}
